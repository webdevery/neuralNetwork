  ...
  _createClass(Brain, [{
    ...
    value: function init() {
      ...
      this.opts.layers.forEach(function (layer, key) {
        ...
        _this.layers.push(new _details.NeuralsLayer(count));
      });

      for (var i = 1; i < this.layers.length; i++) {
        this.weights.push(new _details.Weights(this.layers[i - 1], this.layers[i], this.opts.offset));
      }
    }
  }, {
    key: "learn",
